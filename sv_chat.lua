...
--[[
                                ...
                                THIS FILE NEEDS TO REPLACE SV_CHAT.LUA IN THE FOLLOWING DIRECTORY:

                                /RESOURCES/[GAMEPLAY]/CHAT/<SV_CHAT.LUA>

                                IF YOU DO NOT REPLACE THIS FILE IT WILL LEAD TO DOUBLE MESSAGES IN GLOBAL CHAT & BASE JOIN/LEAVE HANDLING
                                ...
                                IF YOU ARE STILL UNSURE WHERE THIS GOES, OR HAVE ANY QUERIES PLEASE CONTACT ME ON DISCORD:
                                                    https://discord.gg/RsRr2J8wws
...
local function routeMessage(source, author, message, mode, fromConsole)
    ...
    --     else
    --         for _, id in ipairs(routingTarget) do                                                   THIS SECTION REMOVES THE DEFAULT CHAT
...
-- AddEventHandler('playerJoining', function()                                           REMOVE BASE JOIN/LEAVE CHAT MESSAGES
